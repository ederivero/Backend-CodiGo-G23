...
SECRET_KEY = 'django-insecure-lf0cm-)r@i%&1w2#)8r_9z9u5dnb!amau^qt^o)%j(atp4(x7t'
...
# https://docs.djangoproject.com/en/5.2/ref/databases/#id13
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'recetario',  # nombre de la bd
        'USER': 'postgres',  # nombre de usuario al servidor de bd
